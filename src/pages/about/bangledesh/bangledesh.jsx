    ...
    const displayView = (isMobile) => {
        ...
        <div className={classes.grid}>
            ...
            <div>
                ...
                <p className={classes.gridText}>Kutupalong refugee camp is one of the newly established refugee<br></br> camps within the UNHCR network. It is mainly made of Rohingya<br></br> refugees that fled neighbouring Myanmar due to ethnic and<br></br> religious persecution by the government. As of June 2020, the<br></br> camp has over 800,000 refugees many of them being children who<br></br> do not have access to a proper education. HSL is currently in the<br></br> process of scouting nearby communities where we will be able to<br></br> partner with the local governments to establish a safe and reliable<br></br> infrastructure for education.</p>
            </div>
        </div>

  ...
  return (
    <>
      <div className={classes.header}>
        <h1 className={mobileView ? classes.mobileHeaderTitle : classes.headerTitle}>Our Mission</h1>
        <br />
        <br />
        <p className={mobileView ? classes.mobileHeaderText : classes.headerText}>
      ...
      <div className={mobileView ? classes.mobileIssueTackling : classes.issueTackling}>
        <Row>
          {mobileView && (
            <Col md={4} className={classes.centerContent}>
          ...
          <Col className={mobileView ? classes.mobileCenterContent : classes.centerContent}>
            <p className={classes.bodyText}>
      ...
      <div className={classes.ourTeam}>
        ...
        <p className={classes.ourTeamText}>
          ...
          team to slowly start building up Haiti. There was no lack of NGOs
          helping the country, but it felt like not much was being done. With just
          the two of us, we began with small, but sustainable projects to help the
          community in meaningful ways. With a new marketing team joining us and
          plans to start an internship program, Hope Sustains Life is growing
        ...
        <div className={classes.founderContainer}>
          <div className={mobileView ? classes.mobileBernard : classes.bernard}>
            ...
            <div className={classes.bernardInfo}>
              <h1 className={mobileView ? classes.mobileName : classes.name}>Bernard Michel</h1>
          ...
          <div className={mobileView ? classes.mobileTheodore : classes.theodore}>
            <Image
              src={TheodoreImage}
            ...
            <div className={classes.theodoreInfo}>
              <h1 className={mobileView ? classes.mobileName : classes.name}>Theodore Michel</h1>
